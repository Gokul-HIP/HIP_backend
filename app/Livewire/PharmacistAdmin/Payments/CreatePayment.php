...
class CreatePayment extends Component
{
    ...
    public $includesProcedures = false;
    public $includesDiagnostics = false;
    public $includesPharmacy = true;
    public bool $canSelectProcedures = false;
    public bool $canSelectDiagnostics = false;
    ...
    public function render()
    {
        ...
        return view('livewire.pharmacist-admin.payments.create-payment', [
