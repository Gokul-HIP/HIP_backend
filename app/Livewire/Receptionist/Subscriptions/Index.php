...
namespace App\Livewire\Receptionist\Subscriptions;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $subscriptions = $query->paginate(10)->withPath(route('receptionist.manage-subscriptions.index'));
        ...
        return view('livewire.receptionist.subscriptions.index', [
