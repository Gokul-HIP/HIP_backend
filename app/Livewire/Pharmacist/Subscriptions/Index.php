...
namespace App\Livewire\Pharmacist\Subscriptions;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $subscriptions = $query->paginate(10)->withPath(route('pharmacist.manage-subscriptions.index'));
        ...
        return view('livewire.pharmacist.subscriptions.index', [
