...
class CreateAd extends Component
{
    ...
    /** Priority type: high, medium, low (stored in DB). Numeric priority is derived from this. */
    public string $priority_type = 'medium';
    public int $priority = 50;
    /** @var array<int, string> placement_type values */
    public array $placements = [];
    /** @var array<int, int> location_master ids */
    ...
    public function render()
    {
        ...
        return view('livewire.admin.ads.create-ad', [
