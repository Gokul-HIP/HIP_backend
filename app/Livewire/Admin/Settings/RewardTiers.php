...
class RewardTiers extends Component
{
    ...
    public function mount(RewardTierService $rewardTierService): void
    {
        ...
        $this->allPackages = DiagnosticPackage::active()->orderBy('name')->get();
    }
    ...
    public function deleteTier(RewardTierService $rewardTierService): void
    {
        ...
        Flux::toast(text: 'Reward tier deleted successfully.', variant: 'success');
    }
    ...
    {
        return view('livewire.admin.settings.reward-tiers')
