...
use App\Models\ReceptionistCredential;
...
class ReceptionistCredentials extends Component
{
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.organization.hospital.receptionist-credentials', [
    ...
    {
        $this->resetInput();
        Flux::modal('add-receptionist-user')->show();
    }

    public function closeModal(): void
    {
        Flux::modal('add-receptionist-user')->close();
        Flux::modal('edit-receptionist-user')->close();
        $this->resetInput();
    }
    ...
    public function createUser(): void
    {
        ...
        $this->resetInput();
        Flux::modal('add-receptionist-user')->close();
        $this->dispatch('toast', type: 'success', message: 'Receptionist created successfully!');
    }
    ...
    public function edit($userId): void
    {
        ...
        Flux::modal('edit-receptionist-user')->show();
    }
    ...
    public function updateUser(): void
    {
        ...
        ReceptionistCredential::updateOrCreate(
            ['hip_user_id' => $user->id],
        ...
        $this->resetInput();
        Flux::modal('edit-receptionist-user')->close();
        $this->dispatch('toast', type: 'success', message: 'Receptionist updated successfully!');
    }

    public function delete($userId): void
    {
        $this->deleteUserId = $userId;
        Flux::modal('delete-receptionist')->show();
    }
    ...
    public function destroy(): void
    {
        ...
        ReceptionistCredential::where('hip_user_id', $user->id)->delete();
        $user->removeRole('receptionist');
        $user->delete();

        $this->deleteUserId = null;
        Flux::modal('delete-receptionist')->close();
        $this->dispatch('toast', type: 'success', message: 'Receptionist deleted successfully!');
    }
}
