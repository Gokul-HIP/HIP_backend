 ...
 */
class SendTemplateNodeProcessor extends AbstractMessagingNodeProcessor
{
    /** @var list<string> */
    ...
    /**
     * AbstractMessagingNodeProcessor requires channel(); sendTemplate reads channel from node data in run().
     */
