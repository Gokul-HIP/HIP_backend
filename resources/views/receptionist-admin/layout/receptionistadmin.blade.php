                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('receptionist.dashboard.index') }}"
                               ...
                               {{ request()->routeIs('receptionist.dashboard.index') ? 'active-menu bg-blue-50 text-blue-700' : 'hover:bg-gray-100' }}">
                        ...
                        <li>
                            <a href="{{ route('receptionist.payments.index') }}"
                               class="flex items-center space-x-3 p-2 rounded transition-colors
                               {{ request()->routeIs('receptionist.payments.*') ? 'active-menu bg-blue-50 text-blue-700' : 'hover:bg-gray-100' }}">
                               <i class="fa-solid fa-indian-rupee-sign"></i><span>Payments</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('receptionist.manage-subscriptions.index') }}"
                               class="flex items-center space-x-3 p-2 rounded transition-colors
                               {{ request()->routeIs('receptionist.manage-subscriptions.*') ? 'active-menu bg-blue-50 text-blue-700' : 'hover:bg-gray-100' }}">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ profileOpen: false }">
                            @php
                                ...
                                $name = trim((string) ($u?->full_name ?? 'Receptionist')) ?: 'Receptionist';
                            ...
                            <div x-show="profileOpen"
                                ...
                                <div class="pp-menu">
                                    ...
                                    <form method="POST" action="{{ route('receptionist.auth.logout') }}">
                                        @csrf
