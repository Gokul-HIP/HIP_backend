...
@section('title', 'Receptionist Admin Dashboard')
...
<div class="pf-wrap">
    ...
    <div class="pf-page-header">
        ...
        <a href="{{ route('receptionist.payments.create') }}" class="pf-btn-new">
    ...
    <div class="pf-body-grid">
        ...
        <div class="pf-card">
            <div class="pf-card-header">
                ...
                <a href="{{ route('receptionist.payments.index') }}" class="pf-view-all">View all payments →</a>
            </div>
        ...
        <div class="pf-right-col">
            <div class="pf-quick-card">
                ...
                <div class="pf-quick-list">
                    <a href="{{ route('receptionist.payments.create') }}" class="pf-quick-item">
                        <i class="fas fa-plus-circle"></i>
                        <span class="pf-quick-item-label">New Payment</span>
                        <i class="fas fa-chevron-right pf-quick-item-arrow"></i>
                    </a>
                    <a href="{{ route('receptionist.payments.index') }}" class="pf-quick-item">
                        <i class="fas fa-list-alt"></i>
                        <span class="pf-quick-item-label">All Payments</span>
                        <i class="fas fa-chevron-right pf-quick-item-arrow"></i>
                    </a>
                    <a href="{{ route('receptionist.manage-subscriptions.index') }}" class="pf-quick-item">
