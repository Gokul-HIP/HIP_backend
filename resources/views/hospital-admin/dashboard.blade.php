    ...
    <div class="px-8 py-6 space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm px-4 py-3 flex flex-wrap items-center justify-between gap-3">
            <div class="flex flex-wrap gap-2">
                <button type="button" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 rounded-xl transition-colors hover:bg-slate-50 whitespace-nowrap" style="border:1px solid #e2e8f0;line-height:1.25;">
                    ...
                    Last 30 Days
                    <svg xmlns="http://www.w3.org/2000/svg" style="width:14px;height:14px;flex-shrink:0;color:#94a3b8;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <button type="button" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 rounded-xl transition-colors hover:bg-slate-50 whitespace-nowrap" style="border:1px solid #e2e8f0;line-height:1.25;">
                    <svg xmlns="http://www.w3.org/2000/svg" style="width:16px;height:16px;flex-shrink:0;color:#94a3b8;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex items-center gap-1.5">
                <button type="button" style="width:36px;height:36px;border:1px solid #e2e8f0;border-radius:0.75rem;display:flex;align-items:center;justify-content:center;color:#94a3b8;" title="Refresh"
                    onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                    <svg xmlns="http://www.w3.org/2000/svg" style="width:16px;height:16px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                    </svg>
                </button>
                <button type="button" style="width:36px;height:36px;border:1px solid #e2e8f0;border-radius:0.75rem;display:flex;align-items:center;justify-content:center;color:#94a3b8;" title="Download"
                    onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                    <svg xmlns="http://www.w3.org/2000/svg" style="width:16px;height:16px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                ...
                <div class="flex items-end justify-between gap-2 px-2" style="height:14rem;">
                    ...
                    <div class="flex flex-col items-center gap-1.5 flex-1">
                        <div class="w-full rounded-t-lg" style="height:{{ $bar['h'] }};background:{{ $bar['active'] ? '#1488CC' : '#e2e8f0' }};"></div>
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex gap-4" style="font-size:10px;">
                        <div class="flex items-center gap-1.5"><div class="w-2.5 h-2.5 rounded-full" style="background:#1488CC;"></div><span class="font-bold text-slate-500 uppercase tracking-wide">Revenue</span></div>
                        <div class="flex items-center gap-1.5"><div class="w-2.5 h-2.5 rounded-full" style="background:#fb7185;"></div><span class="font-bold text-slate-500 uppercase tracking-wide">Refunds</span></div>
                    </div>
                </div>
                <div style="height:14rem;position:relative;">
                    <svg class="w-full" style="height:calc(100% - 1.5rem);" viewBox="0 0 400 200" preserveAspectRatio="none">
                        <defs><linearGradient id="revGrad" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" style="stop-color:#1488CC;stop-opacity:0.18;"/><stop offset="100%" style="stop-color:#1488CC;stop-opacity:0;"/></linearGradient></defs>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                <div class="mb-6">
                    ...
                    <div class="flex gap-4 mt-2" style="font-size:10px;">
                        <div class="flex items-center gap-1.5"><div class="w-2.5 h-2.5 rounded-full" style="background:#1488CC;"></div><span class="font-bold text-slate-500 uppercase tracking-wide">Appointments</span></div>
                        <div class="flex items-center gap-1.5"><div class="w-2.5 h-2.5 rounded-full" style="background:#a855f7;"></div><span class="font-bold text-slate-500 uppercase tracking-wide">Diag. Tests</span></div>
                    </div>
                </div>
                <div style="height:14rem;position:relative;">
                    <svg class="w-full" style="height:calc(100% - 1.5rem);" viewBox="0 0 500 200" preserveAspectRatio="none">
                        <path d="M0,180 L50,150 L100,168 L150,182 L200,162 L250,172 L300,132 L350,142 L400,102 L450,82 L500,72" fill="none" stroke="#1488CC" stroke-width="2.5" stroke-linejoin="round" stroke-linecap="round"/>
                        <path d="M0,198 L50,190 L100,184 L150,193 L200,183 L250,192 L300,172 L350,182 L400,162 L450,152 L500,132" fill="none" stroke="#a855f7" stroke-width="2" stroke-dasharray="5 3" stroke-linejoin="round" stroke-linecap="round"/>
                    </svg>
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                ...
                <div style="height:14rem;position:relative;">
                    <svg class="w-full" style="height:calc(100% - 1.5rem);" viewBox="0 0 400 200" preserveAspectRatio="none">
                        <defs><linearGradient id="growthGrad" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" style="stop-color:#10b981;stop-opacity:0.15;"/><stop offset="100%" style="stop-color:#10b981;stop-opacity:0;"/></linearGradient></defs>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-4">
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col overflow-hidden">
                <div class="p-6 flex-1">
                    ...
                    <div class="space-y-5">
                        <div>
                            <div class="flex items-center justify-between mb-1.5"><span class="text-sm text-slate-600 font-medium">Hospital Services</span><span class="text-sm font-bold text-slate-800">₹7.2M</span></div>
                            <div class="w-full h-2 rounded-full overflow-hidden" style="background:#f1f5f9;"><div class="h-full rounded-full" style="width:70%;background:#1488CC;"></div></div>
                            <p class="text-right mt-1 font-bold text-slate-400" style="font-size:10px;">70%</p>
                        </div>
                        <div>
                            <div class="flex items-center justify-between mb-1.5"><span class="text-sm text-slate-600 font-medium">Pharmacy Orders</span><span class="text-sm font-bold text-slate-800">₹3.1M</span></div>
                            <div class="w-full h-2 rounded-full overflow-hidden" style="background:#f1f5f9;"><div class="h-full rounded-full" style="width:40%;background:#f97316;"></div></div>
                            <p class="text-right mt-1 font-bold text-slate-400" style="font-size:10px;">40%</p>
                        </div>
                        <div>
                            <div class="flex items-center justify-between mb-1.5"><span class="text-sm text-slate-600 font-medium">Diagnostics</span><span class="text-sm font-bold text-slate-800">₹2.1M</span></div>
                            <div class="w-full h-2 rounded-full overflow-hidden" style="background:#f1f5f9;"><div class="h-full rounded-full" style="width:25%;background:#a855f7;"></div></div>
                ...
                <div class="px-6 py-4" style="border-top:1px solid #f1f5f9;">
                    <button type="button" class="w-full text-center text-sm font-bold hover:underline" style="color:#1488CC;">Download Detailed Report</button>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4" style="border-bottom:1px solid #f1f5f9;">
                    ...
                    <button type="button" class="text-xs font-bold uppercase tracking-wide hover:underline" style="color:#1488CC;">View All</button>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4"><div class="flex items-center gap-3"><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:#dbeafe;"><svg class="w-4 h-4" style="color:#2563eb;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/></svg></div><span class="text-sm font-medium text-slate-700">MRI Brain Scan</span></div></td>
                                ...
                                <td class="px-6 py-4 text-xs text-slate-400 whitespace-nowrap">Oct 24, 14:20</td>
                            </tr>
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4"><p class="text-xs font-bold text-slate-500">#TXN-10294</p></td>
                                <td class="px-6 py-4"><div class="flex items-center gap-3"><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:#fef3c7;"><svg class="w-4 h-4" style="color:#d97706;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg></div><span class="text-sm font-medium text-slate-700">Cardiac Meds Pack</span></div></td>
                                ...
                                <td class="px-6 py-4 text-xs text-slate-400 whitespace-nowrap">Oct 24, 15:05</td>
                            </tr>
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4"><p class="text-xs font-bold text-slate-500">#TXN-10295</p></td>
                                <td class="px-6 py-4"><div class="flex items-center gap-3"><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:#f3e8ff;"><svg class="w-4 h-4" style="color:#9333ea;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"/></svg></div><span class="text-sm font-medium text-slate-700">CBC Blood Test</span></div></td>
                                <td class="px-6 py-4"><span class="text-sm font-bold text-slate-800">₹850</span></td>
                                <td class="px-6 py-4"><span class="px-2.5 py-1 rounded-full text-xs font-bold uppercase" style="background:#dcfce7;color:#16a34a;">Success</span></td>
                                <td class="px-6 py-4 text-xs text-slate-400 whitespace-nowrap">Oct 24, 15:45</td>
                            </tr>
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4"><p class="text-xs font-bold text-slate-500">#TXN-10296</p></td>
                                <td class="px-6 py-4"><div class="flex items-center gap-3"><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:#ffe4e6;"><svg class="w-4 h-4" style="color:#e11d48;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg></div><span class="text-sm font-medium text-slate-700">Consultation Fee</span></div></td>
                                ...
                                <td class="px-6 py-4 text-xs text-slate-400 whitespace-nowrap">Oct 23, 11:10</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="flex items-center justify-between px-6 py-4 text-xs text-slate-400" style="border-top:1px solid #f1f5f9;">
                    ...
                    <div class="flex gap-1.5">
                        <button type="button" class="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-slate-50" style="border:1px solid #e2e8f0;"><svg class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/></svg></button>
                        ...
                        <button type="button" class="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-slate-50" style="border:1px solid #e2e8f0;"><svg class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></button>
                    </div>
                </div>
            </div>
        </div>
