...
<style>
    ...
    .cnp-add-member-btn {
        ...
        box-shadow: 0 4px 14px rgba(var(--button-color),0.35);
        flex-shrink: 0;
    }
    .cnp-add-member-btn:hover {
        ...
        box-shadow: 0 6px 20px rgba(var(--button-color),0.5);
    }
    ...
    .cnp-search-box:focus-within {
        ...
        box-shadow: 0 0 0 3px rgba(var(--button-color),0.12);
    }
    ...
    .cnp-member-card:hover {
        border-color: #93c5fd;
        box-shadow: 0 2px 10px rgba(var(--button-color),0.1);
    }
    ...
    .cnp-next-btn {
        ...
        font-family: 'Inter', sans-serif;
        transition: background 0.17s, box-shadow 0.17s, transform 0.12s;
        box-shadow: 0 4px 14px rgba(var(--button-color),0.4);
        text-decoration: none;
    }
    .cnp-next-btn:hover {
        background: var(--button-hover);
...
<div class="cnp-wrap">
    ...
    <div class="cnp-body">
        ...
        @elseif(($step ?? 1) === 2)
            @include('livewire.cashier-admin.payments.steps.procedures')

        @elseif(($step ?? 1) === 3)
            @include('livewire.cashier-admin.payments.steps.lab')

        @elseif(($step ?? 1) === 4)
            @include('livewire.cashier-admin.payments.steps.pharmacy')

        @elseif(($step ?? 1) === 5)
            @include('livewire.cashier-admin.payments.steps.review')

        @elseif(($step ?? 1) === 6)
            @include('livewire.cashier-admin.payments.steps.finish')
        @endif
