                ...
                <div class="flex justify-between items-start">
                    ...
                    <div x-data="{ open:false }" class="relative">
                        ...
                        <button
                            ...
                            font-medium rounded-md text-sm px-4 py-2.5 focus:outline-none" style="background: var(--button-color); hover:bg-button-hover">
            ...
            <div class="bg-white rounded-lg p-6 mb-6 card-shadow">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('technician.upload-report.create', ['booking_id' => $diagnosticBooking->id]) }}"
                       class="text-white px-4 py-2 rounded-md text-sm font-medium btn-hover inline-flex items-center gap-2" style="background: var(--button-color);">
