...
<style>
    ...
    .cnp-add-member-btn {
        ...
        box-shadow: 0 4px 14px var(--button-hover);
        flex-shrink: 0;
    }
    .cnp-add-member-btn:hover {
        ...
        box-shadow: 0 6px 20px var(--button-hover);
    }
    ...
    .cnp-member-card:hover {
        ...
        box-shadow: 0 2px 10px var(--button-hover);
    }
    ...
    .cnp-member-check {
        ...
        box-shadow: 0 2px 6px var(--button-color);
    }
...
<div class="cnp-wrap">
    ...
    <div class="cnp-body">
        ...
        @elseif(($step ?? 1) === 2)
            @include('livewire.technician-admin.payments.steps.procedures')

        @elseif(($step ?? 1) === 3)
            @include('livewire.technician-admin.payments.steps.lab')

        @elseif(($step ?? 1) === 4)
            @include('livewire.technician-admin.payments.steps.pharmacy')

        @elseif(($step ?? 1) === 5)
            @include('livewire.technician-admin.payments.steps.review')

        @elseif(($step ?? 1) === 6)
            @include('livewire.technician-admin.payments.steps.finish')
        @endif
    ...
    <div class="cnp-footer">
        ...
        {{-- Cancel --}}
        <a href="{{ route('technician.payments.index') }}" class="cnp-cancel-btn">
        ...
        <div class="cnp-footer-right">
            ...
            @else
                <a href="{{ route('technician.payments.create') }}" class="cnp-next-btn">
                    Create New Payment
