...
<div class="p-6">
    <div class="max-w-xl mx-auto bg-white rounded-2xl shadow-lg border border-slate-200 overflow-visible">
        ...
        <div class="p-8 pb-6 border-b border-slate-100">
            <h1 class="text-2xl font-bold text-slate-900">Edit Referral</h1>
            <p class="text-slate-500 text-sm mt-1">Update the referral details using the same two-step form.</p>
    ...
    <div class="max-w-xl mx-auto space-y-5">
        ...
        <div class="mb-2">
            <p class="text-sm text-slate-500 mb-1">
                ...
                <span class="text-slate-700 font-medium">Edit Referral</span>
            </p>
            <h1 class="text-2xl font-bold text-slate-900">Edit Referral</h1>
            <p class="text-sm text-slate-500 mt-0.5">Update member information for this referral.</p>
        </div>
