<div style="padding: 28px 32px;">
    ...
    <div class="pd-patient-card">
        ...
        <div class="pd-patient-actions">
            ...
            <button type="button" class="btn-pd-primary" wire:click="bookFollowUp">Book Follow-up</button>
        </div>
    </div>
    ...
    <div class="pd-filters-bar">
        ...
        <select class="pd-select" wire:model.live="branchFilter">
    ...
    <div class="pd-main-layout">
        ...
        <div class="pd-table-card">
            ...
            @if($documents->total() > 0)
                <x-doctor.pagination-footer :paginator="$documents" label="documents" />
            @endif
        </div>
