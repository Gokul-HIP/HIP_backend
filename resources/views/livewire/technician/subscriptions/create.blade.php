<div class="max-w-2xl mx-auto px-6 py-6">
    <div class="mb-6">
        <a href="{{ route('technician.manage-subscriptions.index') }}" class="text-sm text-sky-600 hover:underline">← Back to subscriptions</a>
    ...
    <form wire:submit="submit" class="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" wire:loading.attr="disabled" wire:target="submit"
                class="px-5 py-2.5 text-white font-semibold text-sm rounded-lg hover:-translate-y-0.5 transition-all" style="background: var(--button-color); disabled:opacity-60">
            ...
            <a href="{{ route('technician.manage-subscriptions.index') }}" class="px-5 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-600 hover:bg-slate-50">Cancel</a>
        </div>
    </form>
</div>
