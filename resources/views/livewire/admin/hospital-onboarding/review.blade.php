<div class="p-6 min-h-screen  dark:bg-slate-900">
    <div class="max-w-[1600px] mx-auto">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
            ...
            <div class="xl:col-span-1 space-y-6">
                <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="px-3 py-1 bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 text-xs font-semibold rounded">APPROVED</span>
                        @elseif($hospital->onboarding_status == 'rejected')
                        <span class="px-3 py-1 bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 text-xs font-semibold rounded">REJECTED</span>
                        @endif
                    </div>
                    <p class="text-sm text-slate-600 dark:text-slate-400 mb-5 leading-relaxed">Submitted on {{ $hospital->created_at->format('M d, Y') }}. Please review all 5 mandatory documents for verification.</p>
                    ...
                    <div class="space-y-3">
                        ...
                        <div 
                            ...
                            {{ $selectedDocument === 'hospital_details' ? 'border-primary bg-sky-50/50 dark:bg-sky-900/10' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 bg-white dark:bg-slate-800' }}" >
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-lg bg-slate-800 dark:bg-slate-700 flex items-center justify-center text-white flex-shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">Hospital Details</p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400">Basic Hospital Details</p>
                                </div>
                                @if($hospital->basic_details_status == 'submitted')
                                <span class="px-2.5 py-1 bg-slate-100 text-slate-600 dark:bg-slate-700 dark:text-slate-400 text-[10px] font-semibold rounded uppercase flex-shrink-0">PENDING REVIEW</span>
                                @elseif($hospital->basic_details_status == 'approved')
                                <span class="px-2.5 py-1 bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300 text-[10px] font-semibold rounded uppercase flex-shrink-0">APPROVED</span>
                                @elseif($hospital->basic_details_status == 'rejected')
                                <span class="px-2.5 py-1 bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300 text-[10px] font-semibold rounded uppercase flex-shrink-0">REJECTED</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div 
                            ...
                            class="p-4 rounded-lg border-2 cursor-pointer transition-all hover:shadow-sm
                            {{ $selectedDocument === 'hospital_location' ? 'border-primary bg-sky-50/50 dark:bg-sky-900/10' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 bg-white dark:bg-slate-800' }}">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-400 flex-shrink-0">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10zm-2-8h-2v2h2v-2zm0 4h-2v2h2v-2z"/>
                                    </svg>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">Hospital Location</p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400">Basic Hospital Location</p>
                                </div>
                          ...
                          class="p-4 rounded-lg border-2 cursor-pointer transition-all hover:shadow-sm
                          {{ $selectedDocument === 'hospital_capacity' ? 'border-primary bg-sky-50/50 dark:bg-sky-900/10' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 bg-white dark:bg-slate-800' }}">
                          <div class="flex items-center gap-3">
                              <div class="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-400 flex-shrink-0">
                                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                              ...
                              <div class="flex-1 min-w-0">
                                  <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">Hospital Capacity</p>
                                  <p class="text-xs text-slate-500 dark:text-slate-400">Basic Hospital Capacity</p>
                              </div>
                        ...
                        <div 
                            ...
                            class="p-4 rounded-lg border-2 cursor-pointer transition-all hover:shadow-sm
                            {{ $selectedDocument === 'medical_compliance' ? 'border-primary bg-sky-50/50 dark:bg-sky-900/10' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 bg-white dark:bg-slate-800' }}" >
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-lg bg-slate-800 dark:bg-slate-700 flex items-center justify-center text-white flex-shrink-0">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">Medical Compliance</p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400">Basic Medical Compliance</p>
                                </div>
                        ...
                        <div 
                            ...
                            class="p-4 rounded-lg border-2 cursor-pointer transition-all hover:shadow-sm
                            {{ $selectedDocument === 'contact_details' ? 'border-primary bg-sky-50/50 dark:bg-sky-900/10' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 bg-white dark:bg-slate-800' }}">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-400 flex-shrink-0">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">Contact Details</p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400">Basic Contact Details</p>
                                </div>
            ...
            <div class="xl:col-span-2 space-y-6">
                <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col md:flex-row md:min-h-[700px]">
                    <!-- Document Preview -->
                    <div class="flex-1 bg-slate-50 dark:bg-slate-900 flex flex-col">
                        <div class="p-4 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-semibold text-slate-900 dark:text-slate-100">Preview</span>
                            </div>
                            {{-- <div class="flex items-center gap-2">
                                <button class="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-700 rounded transition-colors text-slate-600 dark:text-slate-400">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <h3 class="font-semibold text-slate-900 dark:text-slate-100 text-base">
                                Hospital Details
                            </h3>
                            ...
                            <div class="pt-3 border-t border-slate-200 dark:border-slate-700">
                                <div class="grid grid-cols-2 gap-3">
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-green-500 text-green-600 dark:text-green-400
                                     font-semibold text-sm hover:bg-green-50 dark:hover:bg-green-900/20 transition-all" wire:click="approveDocument('hospital_details')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                        </svg>
                                        Approve Hospital Details
                                    </button>
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-red-500 text-red-600 dark:text-red-400 font-semibold 
                                    text-sm hover:bg-red-50 dark:hover:bg-red-900/20 transition-all" wire:click="rejectDocument('hospital_details')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="pt-3 border-t border-slate-200 dark:border-slate-700">
                                <div class="grid grid-cols-2 gap-3">
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-green-500 text-green-600 dark:text-green-400
                                     font-semibold text-sm hover:bg-green-50 dark:hover:bg-green-900/20 transition-all" wire:click="approveDocument('hospital_location')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                        </svg>
                                    ...
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-red-500 text-red-600 dark:text-red-400 font-semibold 
                                    text-sm hover:bg-red-50 dark:hover:bg-red-900/20 transition-all" wire:click="rejectDocument('hospital_location')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z"/>
                                        </svg>
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="pt-3 border-t border-slate-200 dark:border-slate-700">
                                <div class="grid grid-cols-2 gap-3">
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-green-500 text-green-600 dark:text-green-400
                                     font-semibold text-sm hover:bg-green-50 dark:hover:bg-green-900/20 transition-all" wire:click="approveDocument('hospital_capacity')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                        </svg>
                                    ...
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-red-500 text-red-600 dark:text-red-400 font-semibold 
                                    text-sm hover:bg-red-50 dark:hover:bg-red-900/20 transition-all" wire:click="rejectDocument('hospital_capacity')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z"/>
                                        </svg>
                        ...
                        <div class="flex-1 p-8 overflow-y-auto">
                            <h3 class="font-semibold text-slate-900 dark:text-slate-100 text-base mb-6">Medical Compliance</h3>
                            <div class="max-w-5xl mx-auto">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                                    ...
                                    <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                                        <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-3">Registration Certificate</h3>
                                        <a href="{{ asset('storage/hospital/documents/' . $registration_certificate) }}" target="_blank" class="block group">
                                            <div class="relative overflow-hidden rounded-lg border-2 border-slate-200 dark:border-slate-700 hover:border-primary transition-all aspect-[4/3] bg-slate-50 dark:bg-slate-900">
                                                ...
                                                <div class="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all flex items-center justify-center">
                                                    <div class="opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-slate-800 rounded-full p-3 shadow-lg">
                                    ...
                                    @if($ownership_proof)
                                    <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                                        <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-3">Ownership Proof</h3>
                                    ...
                                    <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                                        <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-3">Accreditation Certificate</h3>
                                    ...
                                    <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                                        <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-3">Fire Safety Certificate</h3>
                                    ...
                                    <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                                        <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-3">Ownership Proof Document</h3>
                                ...
                                <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6">
                                        <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-3">Insurance Policy Number</h3>
                                        <input 
                                            type="text" 
                                            value="{{ $insurance_policy_number }}" 
                                            readonly
                                            class="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-mono text-base focus:outline-none cursor-default"
                                        >
                                    </div>
                                    @endif
                                </div>
                                <div class="pt-3 border-t border-slate-200 dark:border-slate-700">
                                    <div class="grid grid-cols-2 gap-3">
                                        <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-green-500 text-green-600 dark:text-green-400
                                        font-semibold text-sm hover:bg-green-50 dark:hover:bg-green-900/20 transition-all" wire:click="approveDocument('medical_compliance')">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                            </svg>
                                        ...
                                        <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-red-500 text-red-600 dark:text-red-400 font-semibold 
                                        text-sm hover:bg-red-50 dark:hover:bg-red-900/20 transition-all" wire:click="rejectDocument('medical_compliance')">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z"/>
                                            </svg>
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="pt-3 border-t border-slate-200 dark:border-slate-700">
                                <div class="grid grid-cols-2 gap-3">
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-green-500 text-green-600 dark:text-green-400
                                     font-semibold text-sm hover:bg-green-50 dark:hover:bg-green-900/20 transition-all" wire:click="approveDocument('contact_details')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                        </svg>
                                    ...
                                    <button class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 border-red-500 text-red-600 dark:text-red-400 font-semibold 
                                    text-sm hover:bg-red-50 dark:hover:bg-red-900/20 transition-all" wire:click="rejectDocument('contact_details')">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z"/>
                                        </svg>
                    ...
                    <!-- Review Panel -->
                    <div class="w-full md:w-[380px] p-6 flex flex-col border-l border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                        <h3 class="font-bold text-slate-900 dark:text-slate-100 mb-6 text-base">Review Panel</h3>
                        <div class="flex-1 space-y-6 overflow-y-auto pr-2" style="scrollbar-width: thin; scrollbar-color: #cbd5e1 transparent;">
                            <!-- Review Status -->
                            <div>
                                <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Review Status</label>
                                <div class="grid grid-cols-2 gap-3">
                                    <button 
                                        ...
                                        {{ $reviewStatus === 'approved' ? 'border-green-500 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400' : 'border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400 hover:border-green-500 hover:text-green-600' }} 
                                    ...
                                    <button 
                                        ...
                                        class="flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border-2 transition-all
                                        {{ $reviewStatus === 'rejected' ? 'border-red-500 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400' : 'border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400 hover:border-red-500 hover:text-red-600' }}
                                        font-semibold text-sm">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z"/>
                                        </svg>
                            ...
                            <!-- Internal Comments -->
                            <div>
                                <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Internal Comments</label>
                                <textarea 
                                    wire:model="reviewComments"
                                    class="w-full rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 text-sm text-slate-900 dark:text-slate-100 
                            ...
                            <!-- Info Box -->
                            <div class="bg-blue-50 dark:bg-blue-900/20 p-3.5 rounded-lg border border-blue-100 dark:border-blue-900/30">
                                <p class="text-xs text-blue-700 dark:text-blue-300 flex items-start gap-2 leading-relaxed">
                        ...
                        <!-- Action Buttons -->
                        <div class="pt-6 mt-6 border-t border-slate-200 dark:border-slate-700 space-y-3">
                            <button 
                            ...
                            <button 
                                ...
                                class="w-full text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 text-sm font-medium py-2 transition-all">
                                Skip for Now
                            </button>
                        </div>
                    </div>
