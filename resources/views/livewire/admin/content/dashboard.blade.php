    ...
    <div class="flex items-start justify-between mb-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-md">
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.content-moderation.create') }}" class="flex flex-col items-center justify-center text-white rounded-lg px-5 py-3 text-xs font-semibold 
                transition-colors gap-1.5 min-w-[90px] hover:shadow-lg transition-shadow duration-300" style="background:var(--button-color); color:#ffffff !important; hover:background:var(--button-hover);">
                ...
                transition-colors gap-1.5 min-w-[90px] hover:shadow-lg transition-shadow duration-300">
                    ...
                    <span class="text-center leading-tight">Review Comments & Likes</span>
                </button>
                <button class="flex flex-col items-center justify-center bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg px-5 py-3 text-xs font-semibold 
                transition-colors gap-1.5 min-w-[90px] hover:shadow-lg transition-shadow duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
