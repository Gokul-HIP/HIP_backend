        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-lg p-5 mb-6 card-shadow">
                <div class="flex items-center gap-8 flex-wrap">
                    ...
                    <div class="flex items-center gap-2 text-gray-600">
                        ...
                        <span class="text-sm">{{ $doctorBooking->consultation_type }}</span>
                    </div>
                </div>
            </div>
                                ...
                                @foreach(['pending','confirmed','completed','cancelled'] as $item)
                                    <li>
                                        <button
                                            ...
                                            {{ $doctorBooking->status === $item ? 'bg-blue-50 text-[#0DA2E7]' : '' }}">
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">HIP-{{ str_pad($doctorBooking->member->id, 4, '0', STR_PAD_LEFT) }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Name:</span>
                            <span class="text-gray-900 text-sm">{{ $doctorBooking->member->first_name ?? '-' }} {{ $doctorBooking->member->last_name ?? '-' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Phone:</span>
                            <span class="text-gray-900 text-sm">+91 {{ $doctorBooking->mobile_number ?? '-' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Email:</span>
                            <span class="text-gray-900 text-sm">{{ $doctorBooking->member->email ?? '-' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ $doctorBooking->name ?? '-' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Phone:</span>
                            <span class="text-gray-900 text-sm">+91 {{ $doctorBooking->mobile_number ?? '-' }}</span>
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        ...
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">DOC-{{ str_pad($doctorBooking->doctor->id, 4, '0', STR_PAD_LEFT) }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Specialty:</span>
                            <span class="text-gray-900 text-sm">{{ $doctorBooking->doctor->speciality_names ?? '-' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ optional($doctorBooking->booking_date)->format('d M ,Y') }}</span>
                        </div>
                        <div class="detail-row">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ $doctorBooking->consultation_type ?? '-' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-6 mb-6 card-shadow">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Routine pediatric checkup and vaccination followup</p>
                </div>
            </div>
