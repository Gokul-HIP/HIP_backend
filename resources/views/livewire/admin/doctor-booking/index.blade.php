<div class="space-y-6" 
    ...
    <!-- OVERVIEW -->
    <div>
        <h2 class="text-2xl font-semibold mb-4 text-gray-900">Doctor Booking Overview</h2>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            <span class="text-xs text-gray-500">
                                {{ $doctorBooking->member?->hip_id ?? 'N/A' }}
                            </span>
                        </td>
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            <br>
                            <span class="text-xs text-gray-500">
                                IOS-{{ $doctorBooking->hospital?->id ? str_pad($doctorBooking->hospital->id, 4, '0', STR_PAD_LEFT) : 'N/A' }}
                            </span>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <x-admin.booking-payment-cell :booking="$doctorBooking" />
                        </td>
