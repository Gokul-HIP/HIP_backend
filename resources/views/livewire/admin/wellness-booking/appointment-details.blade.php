<div>
    ...
    <div class="bg-gray-50 min-h-screen p-6">
        <div class="max-w-7xl mx-auto">
            <a href="{{ route('admin.wellness-booking.index') }}" class="text-blue-600 hover:text-blue-800 text-sm flex items-center gap-1 mb-6">
            ...
            <div class="bg-white rounded-lg p-5 mb-6 card-shadow">
                <div class="flex items-center gap-8 flex-wrap">
                    @if ($wellnessBooking->status == 'confirmed')
                                ...
                                @foreach(['pending','confirmed','completed','cancelled'] as $item)
                                    <li>
                                        <button
                                            ...
                                            {{ $wellnessBooking->status === $item ? 'bg-blue-50 text-[#0DA2E7]' : '' }}">
            ...
            <!-- Member Details and Person Details Grid -->
                    ...
                    <div>
                        @if($wellnessBooking->member)
                            ...
                            <div class="detail-row">
                                ...
                                <span class="text-gray-900 text-sm">{{ $wellnessBooking->member->first_name ?? '-' }} {{ $wellnessBooking->member->last_name ?? '-' }}</span>
                            </div>
                            <div class="detail-row">
                                <span class="text-gray-500 text-sm font-medium">Phone:</span>
                                <span class="text-gray-900 text-sm">+91 {{ $wellnessBooking->mobile_number ?? '-' }}</span>
                            </div>
                            <div class="detail-row">
                                <span class="text-gray-500 text-sm font-medium">Email:</span>
                                <span class="text-gray-900 text-sm">{{ $wellnessBooking->member->email ?? '-' }}</span>
                            </div>
                        @else
                            <p class="text-gray-500 text-sm">No member information available</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ $wellnessBooking->name ?? '-' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Phone:</span>
                            <span class="text-gray-900 text-sm">+91 {{ $wellnessBooking->mobile_number ?? '-' }}</span>
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        @if($wellnessBooking->center)
                            <div class="detail-row">
                                <span class="text-gray-500 text-sm font-medium">Centre Name:</span>
                                <span class="text-gray-900 text-sm">{{ $wellnessBooking->center->centre_name ?? '-' }}</span>
                            </div>
                            <div class="detail-row">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="text-gray-900 text-sm">+91 {{ $wellnessBooking->center->contact_person_mobile ?? '-' }}</span>
                            </div>
                        @else
                            <p class="text-gray-500 text-sm">No center information available</p>
                        @endif
                    </div>
                </div>
                ...
                {{-- <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ optional($wellnessBooking->booking_date)->format('d M ,Y') }}</span>
                        </div>
                        <div class="detail-row">
            ...
            <div class="bg-white rounded-lg p-6 mb-6 card-shadow">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">{{ $wellnessBooking->purpose ?? 'wants to know more' }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-6 mb-6 card-shadow">
                ...
                <h3 class="text-[#0DA2E7] text-sm font-semibold mb-3">Admin Comments History:</h3>
