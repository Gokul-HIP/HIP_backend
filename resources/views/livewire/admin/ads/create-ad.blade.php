<div x-data="{}">
    ...
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
        ...
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Create Ad</h1>
            <p class="text-slate-400 text-sm mt-1">Set up and publish promotional content for the HIP app.</p>
        </div>
        ...
        <form wire:submit.prevent="save" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div class="space-y-5">
                    ...
                    <div class="form-card">
                        ...
                        <div class="mb-4"
                             x-data="{
                                 ...
                                 clearPreview() {
                                     ...
                                     const fi = document.getElementById('adMediaFile'); if (fi) fi.value = '';
                            ...
                            <label class="form-label">Upload Media <span class="text-rose-500">*</span></label>
                            <input type="file" id="adMediaFile" wire:model="media_file" accept="image/*,video/*" @change="handleFileChange($event)" class="hidden">

                            <!-- Empty state -->
                            <div x-show="!previewUrl">
                                <label for="adMediaFile" class="upload-box flex flex-col items-center justify-center gap-3 w-full py-10 px-4 cursor-pointer block">
                        ...
                        <!-- Hospital — custom dropdown same style as others -->
                        <div>
                            ...
                            <div x-data="{
                                    ...
                                    val: '',
                                    label: 'All Hospitals',
                                    opts: @js($hospitals->map(fn($h) => ['id' => (string)$h->id, 'name' => $h->name ?? $h->hospital_name ?? 'Hospital #'.$h->id])->prepend(['id' => '', 'name' => 'All Hospitals'])->values()->all()),
            ...
            <div class="mt-6 flex flex-wrap items-center justify-end gap-3 border-t border-slate-200 pt-4">
                <a href="{{ route('admin.ads.ad-management.index') }}"
