            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($ads as $ad)
                    @php
                        ...
                        $prioLabel = \App\Livewire\Admin\Ads\AdManagement::priorityLabel((int) ($ad->priority ?? 50));
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="tbl-td">
                            <div class="flex gap-4">
                                ...
                                <div><p class="text-xs text-gray-500">Clicks</p><p class="font-bold text-gray-900 text-sm">{{ \App\Livewire\Admin\Ads\AdManagement::formatCount($ad->clicks_count ?? 0) }}</p></div>
                            </div>
                        </td>
                        <td class="tbl-td">
                            ...
                            <div class="action-menu-wrapper">
                                ...
                                <div x-show="openMenuId === {{ $ad->id }}"
                                    ...
                                    <ul class="p-2 text-sm text-gray-700 font-medium">
                                        <li>
                                            <a href="{{ route('admin.ads.ad-management.engagement', ['ad_id' => $ad->id]) }}"
                                        ...
                                        <li>
                                            <a href="{{ route('admin.ads.ad-management.edit-ad', ['id' => $ad->id]) }}"
                                               @click="openMenuId = null"
                                               class="inline-flex items-center w-full p-2 hover:bg-gray-100 rounded">
