            ...
            <div>
                ...
                <div class="flex justify-end gap-4 mt-4">
                    ...
                    <button
                        ...
                        <span wire:loading.remove wire:target="createUser" style="color:#ffffff !important;">Add Cashier Admin</span>
            ...
            <div>
                ...
                <div class="flex justify-end gap-4 mt-4">
                    ...
                    <button
                        ...
                        wire:loading.attr="disabled"
                        class="px-4 py-2 rounded-lg text-sm font-medium shadow disabled:opacity-50" style="background:var(--button-color); color:#ffffff !important;">
                        <span wire:loading.remove wire:target="updateUser" style="color:#ffffff !important;">Update Cashier Admin</span>
