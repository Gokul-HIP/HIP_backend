<div class="space-y-6"  x-data 
    ...
    <!-- OVERVIEW -->
    <div class="">
        <h2 class="text-lg font-semibold mb-4">Hospital Admin List</h2>
    </div>
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="ml-auto flex-shrink-0">
                <button 
                    ...
                    <span class="hidden sm:inline text-white">Add Admin User</span>
                </button>
            </div>
        ...
        <div x-data @click.outside="$wire.closeModal()">
            <div>
                ...
                <p class="text-sm text-gray-500 mb-6 leading-relaxed">
                    You're about to delete this Admin User.<br>
            ...
            <div>
                ...
                <div class="flex justify-end gap-4 mt-4">
                    ...
                    <button
                        ...
                        <span wire:loading.remove wire:target="createUser">Add Admin User</span>
            ...
            <div>
                ...
                <div class="flex justify-end gap-4 mt-4">
                    ...
                    <button
                        ...
                        wire:loading.attr="disabled"
                        class="bg-[#0da2e7] hover:bg-[#0da2e7]/80 text-white px-4 py-2 rounded-lg text-sm font-medium shadow disabled:opacity-50">
                        <span wire:loading.remove wire:target="updateUser">Update Admin User</span>
