<div class="space-y-6"  x-data 
    ...
    <!-- OVERVIEW -->
    <div class="">
        <h2 class="text-lg font-semibold mb-4">Pharmacist List</h2>
    </div>
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="ml-auto flex-shrink-0">
                <button 
                    ...
                    <span class="hidden sm:inline text-white">Add Pharmacist</span>
                </button>
            </div>
    ...
    <flux:modal name="delete-pharmacist" class="p-0" wire:close="closeModal" id="delete-org">
    ...
    <flux:modal name="add-pharmacist-user" class="p-0" wire:close="closeModal" id="delete-org">
        <div x-data @click.outside="$wire.closeModal()">
            <div>
                ...
                <div class="flex justify-end gap-4 mt-4">
                    ...
                    <button
                        ...
                        <span wire:loading.remove wire:target="createUser" style="color:#ffffff !important;">Add Pharmacist</span>
    ...
    <flux:modal name="edit-pharmacist-user" class="p-0" wire:close="closeModal" id="delete-org">
        <div x-data @click.outside="$wire.closeModal()">
            <div>
                <h2 class="text-lg font-semibold text-gray-900 mb-4">
                    Edit Pharmacist
                ...
                <div class="flex justify-end gap-4 mt-4">
                    ...
                    <button
                        ...
                        wire:loading.attr="disabled"
                        class="px-4 py-2 rounded-lg text-sm font-medium shadow disabled:opacity-50" style="background:var(--button-color); color:#ffffff !important;">
                        <span wire:loading.remove wire:target="updateUser" style="color:#ffffff !important;">Update Pharmacist</span>
