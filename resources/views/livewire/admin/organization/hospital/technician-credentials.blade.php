<div class="space-y-6"  x-data 
    ...
    <!-- OVERVIEW -->
    <div class="">
        <h2 class="text-lg font-semibold mb-4">Technician List</h2>
    </div>
    ...
    <flux:modal name="delete-technician" class="p-0" wire:close="closeModal" id="delete-org">
    ...
    <flux:modal name="add-technician-user" class="p-0" wire:close="closeModal" id="delete-org">
        <div x-data @click.outside="$wire.closeModal()">
            <div>
    ...
    <flux:modal name="edit-technician-user" class="p-0" wire:close="closeModal" id="delete-org">
        <div x-data @click.outside="$wire.closeModal()">
            <div>
                <h2 class="text-lg font-semibold text-gray-900 mb-4">
                    Edit Technician
