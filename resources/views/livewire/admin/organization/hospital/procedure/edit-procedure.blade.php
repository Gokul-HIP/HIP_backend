    ...
    <flux:modal name="edit-procedure" class="p-0" wire:close="closeModal">
        <div x-data="modalHandler()" @click.outside="$wire.closeModal()">
            <div class="relative max-w-5xl mx-auto">
                ...
                <h1 class="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 pr-8">Edit Procedure</h1>

            <form wire:submit.prevent="updateProcedure">
                ...
                <div class="grid grid-cols-2 gap-10 mt-4">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Procedure Name -->
                        <div>
                            <label class="block text-sm font-medium mb-2">Procedure Name <span class="text-red-500">*</span></label>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <button type="button"
                                @click="open = !open"
                                class="inline-flex items-center justify-between w-full border rounded-lg px-4 py-2.5 bg-white">
                                <span>
                                    {{ $speciality_id
                        ...
                        <!-- Estimated Time -->
                        <div>
                            <label class="block text-sm font-medium mb-2">Estimated Time <span class="text-red-500">*</span></label>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="procedure_code"
                                class="w-full px-4 py-2 rounded-lg border glass-input bg-gray-50"
                                placeholder="Procedure Code" readonly>
                        </div>

                        <!-- Cost -->
                        <div>
                            <label class="block text-sm font-medium mb-2">Cost (₹) <span class="text-red-500">*</span></label>
                ...
                <div class="mt-6">
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-t mt-10">
                        ...
                        <flux:button type="submit"
                            ...
                            <span class="text-white">Update Procedure</span>
                        </flux:button>
                    </div>
