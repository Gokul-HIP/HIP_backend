<flux:modal name="bulk-add-procedure" class="p-0" x-on:close="$wire.resetInput()">
<div class="p-6 bg-gray-100 min-h-[600px]">

    <!-- HEADER -->
    <h2 class="text-xl font-semibold mb-2">Add Procedures in Bulk</h2>
    ...
    @if($step === 1)
        @include('livewire.admin.organization.hospital.procedure.steps.select-procedures')
    @elseif($step === 2)
        @include('livewire.admin.organization.hospital.procedure.steps.review-procedures')
    @endif
    ...
    <div class="flex items-center justify-between mt-6">
        ...
        @else
            <flux:button variant="primary" wire:click="save" class="flex items-center gap-2 bg-green-600 text-white hover:bg-green-700">
                ...
                <span class="hidden sm:inline text-white">Save Procedures</span>
