        ...
        <button type="button"
            ...
            <form wire:submit.prevent="saveLabTest" enctype="multipart/form-data">
                ...
                <div class="flex justify-end gap-4 mt-10">
                    ...
                    <flux:button variant="primary" type="submit" class="flex items-center gap-2 text-white hover:opacity-90 transition w-full sm:w-auto" style="background:var(--button-color); color:#ffffff !important;">
                        <i class="fa-solid fa-check mr-2" style="color:#ffffff !important;"></i>
                        <span class="hidden sm:inline" style="color:#ffffff !important;">Save Lab Test</span>
