            ...
            <form wire:submit.prevent="updateLabTest" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-t mt-10">
                        <flux:button wire:click="closeModal" type="button" class="px-6 py-2.5 bg-red-500 text-white rounded-lg text-sm font-medium transition w-full sm:w-auto" style="background:#f14336; color:#ffffff !important;">
                        ...
                        <flux:button wire:click="resetInput" type="button" class="px-6 py-2.5 bg-gray-300 rounded-lg text-sm font-medium transition w-full sm:w-auto" style="background:#6b7280; color:#ffffff !important;">
                        ...
                        <flux:button type="submit"
                            ...
                            <span class="hidden sm:inline" style="color:#ffffff !important;" x-text="imageUploading ? 'Uploading...' : 'Update Lab Test'"></span>
