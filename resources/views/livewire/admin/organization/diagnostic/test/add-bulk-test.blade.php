<flux:modal name="bulk-add-test" class="p-0" wire:close="closeModal">
    <div 
        ...
        "
        @modal-show.window="
            if ($event.detail.name === 'bulk-add-test') {
                modalReady = false;
...
<div class="p-4 sm:p-6 bg-gray-100 min-h-[600px]">
    ...
    <!-- HEADER -->
    <h2 class="text-xl font-semibold mb-2">Add Tests in Bulk</h2>
    ...
    @if($step === 1)
        @include('livewire.admin.organization.diagnostic.test.steps.select-tests')
    @elseif($step === 2)
        @include('livewire.admin.organization.diagnostic.test.steps.review-tests')
    @endif
        ...
        <div class="flex items-center gap-4">
            ...
            @else
                <flux:button variant="primary" wire:click="save" class="flex items-center gap-2 bg-green-600 text-white hover:bg-green-700">
                    ...
                    <span class="hidden sm:inline text-white" style="color:#ffffff !important;">Save Tests</span>
