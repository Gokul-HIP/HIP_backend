<div>
    ...
    <flux:modal name="add-diagnostic" class="p-0" wire:close="closeModal">
        <div x-data="{ modalReady: false }" 
             ...
             "
             @modal-show.window="
                if ($event.detail.name === 'add-diagnostic') {
                    modalReady = false;
        ...
        <button type="button"
            ...
            <h1 class="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 pr-8">Add New Diagnostic Center</h1>
            <form wire:submit.prevent="addDiagnosticCenter" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div x-data="{ 
                            ...
                            clearPreview() {
                                ...
                                const fileInput = document.getElementById('diagnosticLogo');
                        ...
                        @reset-file-input.window="
                            ...
                            if (fileInput) fileInput.value = '';
                        ">
                            <label class="block text-sm font-medium mb-2">Upload Diagnostic Center Logo/Image</label>

                            <!-- Upload Box -->
                            <div onclick="document.getElementById('diagnosticLogo').click()"
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 pt-4 border-t">  
                    ...
                    <flux:button variant="primary" type="submit" 
                        ...
                        <span class="hidden sm:inline" style="color:#ffffff !important;">Save Diagnostic Center</span>
