            ...
            <div class="grid grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-t mt-10">
                        <flux:button wire:click="closeModal" type="button" class="px-6 py-2.5 bg-red-500 text-white rounded-lg text-sm font-medium transition w-full sm:w-auto" 
                        ...
                        <flux:button type="submit"
                            ...
                            <span class="hidden sm:inline" style="color:#ffffff !important;" x-text="imageUploading ? 'Uploading...' : 'Update Product'"></span>
