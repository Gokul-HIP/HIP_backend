        ...
        <h1 class="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 pr-8">Add New Pharmacy Product</h1>
            ...
            <form wire:submit.prevent='addPharmacyProduct' method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end gap-4 mt-10">
                    ...
                    <flux:button variant="primary" type="submit" class="flex items-center gap-2 text-white hover:opacity-90 transition w-full sm:w-auto" style="background:var(--button-color);">
                        <i class="fa-solid fa-check mr-2" style="color:#ffffff !important;"></i>
                        <span class="hidden sm:inline" style="color:#ffffff !important;">Save Product</span>
