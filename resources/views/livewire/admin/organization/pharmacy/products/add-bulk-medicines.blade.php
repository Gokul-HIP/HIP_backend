<flux:modal name="bulk-add-medicines" class="p-0" wire:close="closeModal">
    <div 
        ...
        "
        @modal-show.window="
            if ($event.detail.name === 'bulk-add-medicines') {
                modalReady = false;
        ...
        <div class="flex items-center gap-4">
            ...
            @else
                <flux:button variant="primary" wire:click="save" class="flex items-center gap-2 bg-green-600 text-white hover:bg-green-700">
                    ...
                    <span class="hidden sm:inline text-white" style="color:#ffffff !important;">Save Medicines</span>
