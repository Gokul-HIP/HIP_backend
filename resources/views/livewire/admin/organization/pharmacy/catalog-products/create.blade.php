                        ...
                        <div class="space-y-5">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div>
                                    ...
                                    <input wire:model.live.debounce.300ms="mrp" type="number" step="0.01" min="0" class="glass-input w-full px-4 py-2 rounded-lg" placeholder="0.00">
                                ...
                                <div>
                                    ...
                                    <input wire:model.live.debounce.300ms="selling_price" type="number" step="0.01" min="0" class="glass-input w-full px-4 py-2 rounded-lg" placeholder="0.00">
