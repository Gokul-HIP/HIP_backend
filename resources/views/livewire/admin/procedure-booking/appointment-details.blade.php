<div>
    ...
    <div class="bg-gray-50 min-h-screen p-6">
        <div class="max-w-7xl mx-auto">
            <a href="{{ route('admin.procedure-booking.index') }}" class="text-blue-600 hover:text-blue-800 text-sm flex items-center gap-1 mb-6">
                                ...
                                @foreach(['pending','confirmed','completed','cancelled'] as $item)
                                    <li>
                                        <button
                                            ...
                                            {{ $procedureBooking->status === $item ? 'bg-blue-50 text-[#0DA2E7]' : '' }}">
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        ...
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ $procedureBooking->member->first_name ?? '' }} {{ $procedureBooking->member->last_name ?? '' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Phone:</span>
                            <span class="text-gray-900 text-sm">+91 {{ $procedureBooking->mobile_number ?? '-' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Email:</span>
                            <span class="text-gray-900 text-sm">{{ $procedureBooking->member->email ?? '-' }}</span>
                        </div>
                        @else
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Member:</span>
                            <span class="text-gray-900 text-sm">Guest User</span>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ $procedureBooking->name ?? '-' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Phone:</span>
                            <span class="text-gray-900 text-sm">+91 {{ $procedureBooking->mobile_number ?? '-' }}</span>
            ...
            <!-- Procedure Details and Timings Grid -->
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <!-- Procedure Details Card -->
                <div class="bg-white rounded-lg p-6 card-shadow">
                    <div class="flex justify-between items-center mb-5">
                        <h2 class="text-base font-semibold text-gray-900 flex items-center gap-2">
                            <i class="fas fa-procedures text-gray-600"></i>
                            Procedure Details
                        </h2>
                        {{-- <button class="flex items-center gap-2 px-3 py-1.5 border border-gray-300 rounded-md hover:bg-gray-50 transition text-sm">
                            <i class="fas fa-edit text-gray-600"></i>
                    ...
                    <div>
                        ...
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Procedure Name:</span>
                            <span class="text-gray-900 text-sm">{{ $procedureBooking->procedure->procedure_name ?? '-' }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Procedure ID:</span>
                            <span class="text-gray-900 text-sm">PRO-{{ str_pad($procedureBooking->procedure->id, 4, '0', STR_PAD_LEFT) }}</span>
                        </div>
                        @else
                        <div class="detail-row">
                            <span class="text-gray-500 text-sm font-medium">Procedure:</span>
                ...
                <div class="bg-white rounded-lg p-6 card-shadow">
                    ...
                    <div>
                        <div class="detail-row">
                            ...
                            <span class="text-gray-900 text-sm">{{ optional($procedureBooking->booking_date)->format('d M ,Y') }}</span>
                        </div>
                        <div class="detail-row">
            ...
            <div class="bg-white rounded-lg p-6 mb-6 card-shadow">
                ...
                <div>
                    <p class="text-[#0DA2E7] text-sm font-semibold mb-2">MESSAGE :</p>
                    <p class="text-gray-600 text-sm">{{ $procedureBooking->message }}</p>
                </div>
            </div>
            @endif
            ...
            <div class="bg-white rounded-lg p-6 card-shadow">
              ...
              @else
                <div class="text-center py-8 text-gray-500">
                    ...
                    <p class="text-xs mt-1">Status changes will appear here</p>
                </div>
              @endif
