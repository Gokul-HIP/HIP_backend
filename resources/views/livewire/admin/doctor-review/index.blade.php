<div class="space-y-6" 
    ...
    <!-- OVERVIEW -->
    <div>
        <h2 class="text-lg font-semibold mb-4 text-gray-900">Manage Doctor Reviews</h2>
        <h4 class="text-sm text-gray-500 mb-4">Monitor and manage doctor reviews from your patients.</h4>
    </div>
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search member name, doctor name, review..."
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($reviews as $review)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="font-medium text-gray-900">
                                    {{ $review->doctor ? 'Dr. ' . $review->doctor->name : '-' }}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="action-menu-wrapper">
                                    ...
                                    <div id="menu-{{ $review->id }}" class="action-menu hidden">
                                        <ul class="p-2 text-sm text-gray-700 font-medium">
                                            <li>
                                                <a href="{{ route('admin.doctor-review.view', $review->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                ...
                                <p class="text-sm text-gray-600">No doctor reviews match your filters</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <flux:modal name="delete-review" class="p-0" wire:close="closeDeleteReviewModal" id="delete-org">
        <div x-data @click.outside="$wire.closeDeleteReviewModal()">
            ...
            <p class="text-sm text-gray-500 mb-6 leading-relaxed">
                You're about to delete this review.<br>
