...
<div>
    ...
    <div class="flex items-center justify-between px-6 py-4 flex-wrap gap-3">
        <div class="flex gap-2">
            ...
            <a href="{{ route('pharmacist.payments.export') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 transition-colors">
