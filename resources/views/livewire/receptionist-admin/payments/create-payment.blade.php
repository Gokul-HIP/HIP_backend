...
<div class="cnp-wrap">
    ...
    <div class="cnp-body">
        ...
        @elseif(($step ?? 1) === 2)
            @include('livewire.receptionist-admin.payments.steps.procedures')

        @elseif(($step ?? 1) === 3)
            @include('livewire.receptionist-admin.payments.steps.lab')

        @elseif(($step ?? 1) === 4)
            @include('livewire.receptionist-admin.payments.steps.pharmacy')

        @elseif(($step ?? 1) === 5)
            @include('livewire.receptionist-admin.payments.steps.review')

        @elseif(($step ?? 1) === 6)
            @include('livewire.receptionist-admin.payments.steps.finish')
        @endif
    ...
    <div class="cnp-footer">
        ...
        {{-- Cancel --}}
        <a href="{{ route('receptionist.payments.index') }}" class="cnp-cancel-btn">
        ...
        <div class="cnp-footer-right">
            ...
            @else
                <a href="{{ route('receptionist.payments.create') }}" class="cnp-next-btn">
                    Create New Payment
