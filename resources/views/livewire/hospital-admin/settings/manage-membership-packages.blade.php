<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('healthcare.settings.membership-packages.subscriptions') }}"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        @forelse($packages as $package)
            @php
                ...
                $visibleBenefits = array_slice($packageBenefits, 0, 3);
                $moreBenefits = max(0, count($packageBenefits) - 3);
                    ...
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" wire:click="openEditModal({{ $package->id }})"
                                class="text-gray-500 hover:text-[var(--button-color)]">
    ...
    <flux:modal name="family-package-form" class="p-0 max-w-4xl" wire:close="closeModal">
        <div class="p-6 max-h-[85vh] overflow-y-auto">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white border rounded-xl p-5 space-y-4">
                    ...
                    @foreach($benefits as $index => $benefit)
                        <div class="flex items-center gap-2" wire:key="benefit-row-{{ $index }}">
                    ...
                    @endforeach
                    <button type="button" wire:click="addBenefitRow" class="text-sm text-[var(--button-color)]">+ Add Benefit</button>
                </div>
                ...
                <div class="bg-white border rounded-xl p-5 space-y-4">
                    ...
                    @foreach($terms_conditions as $index => $term)
                        <div class="border rounded-lg p-3 space-y-2" wire:key="terms-row-{{ $index }}">
            ...
            <div class="flex justify-end gap-3 mt-6 pt-4 border-t">
                ...
                <button type="button" wire:click="savePackage" class="px-4 py-2 rounded-lg text-white" style="background:var(--button-color);">Save Package</button>
            </div>
        </div>
    </flux:modal>
</div>
