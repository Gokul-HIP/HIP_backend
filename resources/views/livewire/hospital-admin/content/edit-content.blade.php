    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50/40 to-cyan-50/30 p-4 sm:p-6 lg:p-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-slate-800 tracking-tight">Edit Content</h1>
                    <p class="text-slate-400 text-sm mt-0.5">Update the details below to modify your content</p>
                </div>
            </div>
        </div>
                ...
                <div class="xl:col-span-2 space-y-5">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-100"
                         x-data="{
                             ...
                             existingMediaUrl: @js($existing_media_file ? asset('storage/' . $existing_media_file) : null),
                             existingFileType: @js($existing_media_file ? (in_array(strtolower(pathinfo($existing_media_file, PATHINFO_EXTENSION)), ['mp4', 'mov', 'avi']) ? 'video' : 'image') : null),
                             init() {
                                 if (this.existingMediaUrl && !this.previewUrl) {
                                     this.previewUrl = this.existingMediaUrl;
                                     this.fileType = this.existingFileType;
                                 }
                             },
                             handleFileChange(e) {
                         ...
                         @reset-file-input.window="if(previewUrl && previewUrl.startsWith('blob:')) URL.revokeObjectURL(previewUrl); previewUrl=existingMediaUrl; fileType=existingFileType;">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto">
                        ...
                        <button type="submit"
                            ...
                            <span class="hidden sm:inline">Update Content</span>
