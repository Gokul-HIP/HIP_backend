   ...
   <!-- TABLE CARD -->
    <div class="bg-white rounded-lg shadow-md p-6 border">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('healthcare.content.create') }}" class="text-white px-6 py-2 rounded-lg shadow-md flex items-center" style="background:var(--button-color);">
                                ...
                                <div class="action-menu-wrapper">
                                    ...
                                    <div id="menu-{{ $content->id }}" class="action-menu hidden">
                                        <ul class="p-2 text-sm text-gray-700 font-medium">
                                            ...
                                            <li>
                                                <a href="{{ route('healthcare.content.edit', $content->id) }}"
                                                    class="inline-flex items-center w-full p-2 hover:bg-gray-100 rounded">
