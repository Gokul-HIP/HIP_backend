                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('technician.dashboard.index') }}"
                               ...
                               {{ request()->routeIs('technician.dashboard.index') ? 'active-menu bg-blue-50 text-blue-700' : 'hover:bg-gray-100' }}">
                                <i class="fa-regular fa-rectangle-list"></i><span>Dashboard</span>
                            </a>
                        </li>
    
                        <li>
                            <a href="{{ route('technician.payments.index') }}"
                               class="flex items-center space-x-3 p-2 rounded transition-colors
                               {{ request()->routeIs('technician.payments.*') ? 'active-menu bg-blue-50 text-blue-700' : 'hover:bg-gray-100' }}">
                               <i class="fa-solid fa-indian-rupee-sign"></i><span>Payments</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('technician.manage-subscriptions.index') }}"
                               class="flex items-center space-x-3 p-2 rounded transition-colors
                               {{ request()->routeIs('technician.manage-subscriptions.*') ? 'active-menu bg-blue-50 text-blue-700' : 'hover:bg-gray-100' }}">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ profileOpen: false }">
                            @php
                                ...
                                $name = trim((string) ($u?->full_name ?? 'Technician')) ?: 'Technician';
                            ...
                            <div x-show="profileOpen"
                                ...
                                <div class="pp-menu">
                                    ...
                                    <form method="POST" action="{{ route('technician.auth.logout') }}">
                                        @csrf
