...
<head>
    ...
    <style>
    /* Keep dropdown hidden until Alpine boots */
    [x-cloak] { display: none !important; }

    /* Sidebar: keep colors, increase curve */
    aside.sidebar {
        ...
        <aside class="sidebar w-70 bg-white shadow-lg border-r border-gray-200 flex flex-col h-screen min-h-0 overflow-hidden">
            ...
            <nav class="p-4 pt-5 pb-8 space-y-6 flex-1 overflow-y-auto min-h-0 sidebar-nav">
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li><a href="{{ route('admin.settings.setting') }}" class="flex items-center space-x-3 p-2 rounded transition-colors
                            {{ request()->routeIs('admin.settings.setting') ? 'active-menu bg-blue-50 text-blue-700' : 'hover:bg-gray-100' }}">
