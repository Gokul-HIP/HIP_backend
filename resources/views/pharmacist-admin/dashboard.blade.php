...
@section('title', 'Pharmacist Admin Dashboard')
...
<div class="pf-wrap">
    ...
    <div class="pf-page-header">
        <div>
            ...
            <p>Here's your pharmacy activity for today, {{ now()->format('d M Y') }}</p>
        </div>
        <a href="{{ route('pharmacist.payments.create') }}" class="pf-btn-new">
    ...
    <div class="pf-stats-grid">
        <div class="pf-stat-card">
            ...
            <div class="pf-stat-info">
                <div class="pf-stat-label">Total Pharmacy Transactions</div>
        ...
        <div class="pf-stat-card">
            ...
            <div class="pf-stat-info">
                <div class="pf-stat-label">Daily Pharmacy Revenue</div>
        ...
        <div class="pf-stat-card">
            ...
            <div class="pf-stat-info">
                <div class="pf-stat-label">Pending Pharmacy Invoices</div>
    ...
    <div class="pf-body-grid">
        ...
        <div class="pf-card">
            <div class="pf-card-header">
                ...
                <a href="{{ route('pharmacist.payments.index') }}" class="pf-view-all">View all payments →</a>
            </div>
            ...
            @else
                <div class="pf-table-empty">
                    ...
                    <small>Payments you process will appear here</small>
                </div>
            @endif
        </div>
        ...
        <div class="pf-right-col">
            ...
            <div class="pf-quick-card">
                ...
                <div class="pf-quick-list">
                    <a href="{{ route('pharmacist.payments.create') }}" class="pf-quick-item">
                        <i class="fas fa-plus-circle"></i>
                        <span class="pf-quick-item-label">New Payment</span>
                        <i class="fas fa-chevron-right pf-quick-item-arrow"></i>
                    </a>
                    <a href="{{ route('pharmacist.payments.index') }}" class="pf-quick-item">
                        <i class="fas fa-list-alt"></i>
                        <span class="pf-quick-item-label">All Payments</span>
                        <i class="fas fa-chevron-right pf-quick-item-arrow"></i>
                    </a>
                    @if(Route::has('pharmacist.subscriptions.index'))
                        <a href="{{ route('pharmacist.subscriptions.index') }}" class="pf-quick-item">
